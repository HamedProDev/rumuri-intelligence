      ...
      >
        <defs>
          <linearGradient id="neonLine" x1="0" y1="0" x2="1" y2="0">
            <stop offset="0%" stopColor="oklch(0.62 0.19 148)" stopOpacity="0" />
            <stop offset="50%" stopColor="oklch(0.7 0.19 148)" stopOpacity="1" />
            <stop offset="100%" stopColor="oklch(0.65 0.18 160)" stopOpacity="0" />
          </linearGradient>
          <radialGradient id="meshGlow" cx="0.6" cy="0.4" r="0.6">
            <stop offset="0%" stopColor="oklch(0.62 0.19 148)" stopOpacity="0.2" />
            <stop offset="100%" stopColor="oklch(0.62 0.19 148)" stopOpacity="0" />
          </radialGradient>
          <filter id="glow">
